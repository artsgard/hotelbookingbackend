...
public final class MockData {
    ...
    private static final MapperService mapperService = new MapperServiceImpl();
    ...
    public static List<BookerDTO> generateBookers() {
        BookerDTO booker1 = new BookerDTO(1L, new Date(), new Date(),
